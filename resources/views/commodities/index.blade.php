...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">Komoditas</h4>
        <div class="row">
            <div class="col-md-6 col-xl-6">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Form Tambah Komoditas</h5>
                        <small class="text-muted float-end">Default label</small>
                    </div>
                    <div class="card-body">
                        <form class="form-stock" action="{{ route('commodities.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="name">Nama Komoditas</label>
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Masukan nama komoditas" autofocus />
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="uom">Satuan</label>
                                <select id="uom" class="select2 form-select" name="uom">
                                    @foreach ($uom as $uom)
